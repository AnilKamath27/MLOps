...
def run_deployment(config: str, min_accuracy: float):
    ...
    if deploy:
        continuous_deployment_pipeline(data_path=r"/mnt/c/Users/anilk/Desktop/Juypter Notebook/OIBSIP-Internship/OIBSIP-Internship-Car-Price-Prediction/data/car data.csv",min_accuracy=min_accuracy, workers=3, timeout=180)
